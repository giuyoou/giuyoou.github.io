...
const add_id = "woiesklutp8kcmbo"; // app_id
const app_secret = "dkpOeGhXVFdEak1ha1ovbjNQMk5FZz09"; // app_secret
const key = "d5c6d0ee832049c5b7f3b62843e1c98e" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change1").html("一个建立于 22 世纪的小站，存活于互联网的边缘");
    }
});
